...
public class PostGraduateFullTimeScheduleAbstractCrawler extends AbstractCrawler {

  public PostGraduateFullTimeScheduleAbstractCrawler(@Value("${schedule-page.post-graduate.full-time}") String baseUrl) {
