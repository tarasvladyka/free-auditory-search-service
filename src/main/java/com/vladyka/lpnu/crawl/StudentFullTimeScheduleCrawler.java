...
public class StudentFullTimeScheduleCrawler extends AbstractCrawler {

  public StudentFullTimeScheduleCrawler(@Value("${schedule-page.student.full-time}") String baseUrl) {
