...
@Service
public class StudentGroupsCrawlerPT implements ScheduleCrawler {
    ...
    public void crawl() {
        ...
        for (Institute institute : instituteService.findAll()) {
            ...
            List<String> instituteGroups = parseService.parseGroups(urlProvider.getGroupsUrlPT(instAbbr));
            groupService.createAll(instituteGroups, instAbbr, STUDENT, PART_TIME);
